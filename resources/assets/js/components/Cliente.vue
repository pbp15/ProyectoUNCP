                                ...
                                <div class="input-group">
                                    <select class="form-control col-md-3"  v-model="criterio">
                                      <option value="nombre">Nombre</option>
                                       ...
                                       <option value="codigo_pedido">Codigo Pedido</option>
                                ...
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    <td>
                                     ...
                                     <td v-text="persona.num_documento"></td>
                                      <td v-text="persona.codigo_pedido"></td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Codigo Pedidos</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="codigo_pedido" class="form-control" placeholder="Codigo de tu(s) pedido(s)">
    ...
    export default {
        data(){
            ...
            validarPersona(){
                ...
                if(!this.codigo_pedido) this.errorMostrarMsjPersona.push("El codigo de los pedidos no puede estar vacio");
                             ...
                             switch(accion){
                                 ...
                                 case 'actualizar':
                                 {
                                     ...
                                     this.num_documento = data['num_documento'];
                                      this.codigo_pedido=data['codigo_pedido'];
